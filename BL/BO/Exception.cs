...
namespace BO
{
    ...
    public class ExistIdException : Exception
    {
        ...
        public ExistIdException(string message, Exception innerException) :
            base(message, innerException) => ID = (int)((BadIdException)innerException).ID;
    ...
    public class DoubleIdException : Exception
    {
        ...
        { ID = (int)((BadIdException)innerException).ID; }
    ...
    public class DeletedException : Exception
    {
        ...
        public string Mes;
        public DeletedException(string message) : base(message) => Mes = message;
    }
    ...
    {
        public string Mes;
        public LinkException(string message) : base(message) => Mes = message;
    ...
    {
            public string Mes;
            public StuckException(string message) : base(message) => Mes = message;
